...
- (void)initSubViews
{
    ...
    [self.originVolumeSlider mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(self.bgmView.mas_bottom).offset(2);
    ...
    [self.dubVolumeSlider mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(self).offset(60);
        make.top.mas_equalTo(self.originVolumeSlider.mas_bottom);
        make.right.mas_equalTo(self).offset(-24);
        //make.height.mas_equalTo(12);
    }];
...
-(AEMgrView *)bgmView
{
    if (!_bgmView){
        ...
        m0.idx = 0;
        m0.image = [UIImage imageNamed:@"关闭效果"];
        m0.txt  = nil;
        m0.path = nil;
        ...
        m3.idx = 3;
        m3.image = [UIImage imageNamed:@"CA_hotel"];
        m3.txt  = @"加州旅馆";
